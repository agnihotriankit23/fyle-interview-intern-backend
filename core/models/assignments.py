...
class Assignment(db.Model):
    ...
    @classmethod
    def update_grade(cls, _id, new_grade, principal: Principal):
        ...
        # assertions.assert_valid(assignment.grade is not None,'assignment with empty grade cannot be submitted')

        assertions.assert_valid(
            new_grade in ["A", "B", "C", "D"],
            "Invalid grade! Grade must be A, B, C, or D.",
        )
